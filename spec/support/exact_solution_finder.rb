class ExactSolutionFinder
	...
	def construct_vertex_table(vertex_input)
		...
		for vertex in vertex_input
			vertex_table[vertex[:id]] = { x_pos: vertex[:x_pos], y_pos: vertex[:y_pos], cost_of_traversal: vertex[:cost_of_traversal] }
		end
